...
#[openapi(
    ...
    components(schemas(
        ...
        aiwatcher_projector::MissedEvents,
        ...
        aiwatcher_execution::message::RunProjection,
        aiwatcher_execution::state::ExecutionId,
        aiwatcher_execution::state::ExecutionMode,
        aiwatcher_execution::state::ExecutionOwner,
        aiwatcher_execution::state::RunState,
        aiwatcher_execution::state::StateType,
        aiwatcher_execution::state::StepState,
        aiwatcher_execution::state::AttemptRecord,
        aiwatcher_execution::state::StepError,
        aiwatcher_execution::state::FailureClass,
        aiwatcher_execution::state::InputRequest,
        aiwatcher_execution::state::InputAnswer,
        aiwatcher_execution::plan::RuntimeKind,
        aiwatcher_core::ArtifactRef,
        aiwatcher_core::ArtifactKind,
        aiwatcher_execution::CatalogedArtifact,
        aiwatcher_execution::Provenance,
        crate::artifacts::ArtifactContent,
        crate::executions::StartExecutionBody,
        aiwatcher_execution::start::ExecutionTarget,
        crate::executions::ExecutionAccepted,
        aiwatcher_execution::context::ContextSnapshot,
        aiwatcher_execution::context::ContextAction,
        crate::context::RunBlocks,
        aiwatcher_core::ports::EditorSession,
        aiwatcher_execution::plan::StepBlocks,
        aiwatcher_execution::context::RunAction,
        aiwatcher_execution::schedule::rule::Cadence,
        aiwatcher_execution::schedule::rule::OverlapPolicy,
        aiwatcher_execution::schedule::rule::Schedule,
        aiwatcher_execution::schedule::store::ScheduledDefinition,
        crate::executions::ExecutionHistory,
        crate::executions::AppendStreamBody,
        crate::executions::StreamAppended,
        crate::executions::DeciderLeaseBody,
        crate::executions::LeaseReleased,
        crate::executions::TimerBody,
        ...
        aiwatcher_execution::definition::SavedWorkflow,
        crate::schedules::SetScheduleBody,
        crate::schedules::ScheduleView,
        crate::executions::RunView,
        aiwatcher_execution::plan::ExecutionPlan,
        aiwatcher_execution::plan::PlanStep,
        aiwatcher_execution::plan::PlanEdge,
        aiwatcher_execution::plan::PlanId,
        ...
        aiwatcher_execution::plan::RetryPolicy,
        aiwatcher_execution::plan::CachePolicy,
        crate::worker::ClaimRequest,
        crate::worker::WorkAssignment,
        crate::worker::WorkerBody,
        crate::worker::WorkerReport,
        crate::worker::WorkReport,
        crate::worker::Settled,
        crate::worker::Settlement,
        crate::worker::RowsBody,
        aiwatcher_execution::state::FailureClass,
        ...
        aiwatcher_labs::LabSummary,
        aiwatcher_labs::LabPage,
        aiwatcher_labs::LabPublished,
        aiwatcher_labs::PublishLab,
        aiwatcher_labs::LabMeasurement,
        crate::labs::LabDetail,
        crate::labs::LabMeasurementView,
        crate::labs::LabelBody,
        ...
        aiwatcher_datasets::CurationPipeline,
        aiwatcher_datasets::PipelineBlock,
        aiwatcher_datasets::BlockSpec,
        aiwatcher_datasets::BlockPosition,
        aiwatcher_datasets::PipelineEdge,
        aiwatcher_datasets::PipelinePage,
        aiwatcher_datasets::SavePipelineRequest,
        aiwatcher_datasets::SavedPipeline,
        aiwatcher_datasets::BlockTemplate,
        aiwatcher_datasets::BlockTemplatePage,
        aiwatcher_datasets::SaveBlockTemplateRequest,
        ...
        aiwatcher_annotations::integrations::hubs::HubColumn,
        aiwatcher_annotations::integrations::hubs::HubRow,
        aiwatcher_annotations::integrations::hubs::HubRowsPage,
        ...
        aiwatcher_annotations::RightsEvidence,
        aiwatcher_annotations::SourceFile,
        aiwatcher_annotations::StageBatchRequest,
        aiwatcher_annotations::StagedBatch,
        aiwatcher_annotations::BatchPage,
        aiwatcher_annotations::AppendRowsRequest,
        aiwatcher_annotations::AppendReport,
        aiwatcher_annotations::ImportJobRequest,
        aiwatcher_annotations::ImportJob,
        aiwatcher_annotations::ImportJobPage,
        aiwatcher_annotations::ImportCounts,
        aiwatcher_annotations::RejectReason,
        aiwatcher_annotations::RejectedRow,
        aiwatcher_annotations::RejectPage,
        aiwatcher_annotations::ImportManifest,
        aiwatcher_annotations::ImportSummary,
        aiwatcher_annotations::ImportIndex,
        aiwatcher_conversations::Role,
        aiwatcher_conversations::ContentPart,
        aiwatcher_conversations::ToolResult,
        aiwatcher_conversations::TurnContent,
        aiwatcher_conversations::PartSummary,
        aiwatcher_conversations::Provenance,
        aiwatcher_conversations::TurnState,
        aiwatcher_conversations::LawfulBasis,
        aiwatcher_conversations::TrainingScope,
        aiwatcher_conversations::ConsentRecord,
        aiwatcher_conversations::RetentionPolicy,
        aiwatcher_conversations::RedactionRecord,
        aiwatcher_conversations::ContentPolicy,
        aiwatcher_conversations::PolicyMode,
        aiwatcher_conversations::ArchivePolicy,
        aiwatcher_conversations::FindingKind,
        aiwatcher_conversations::Finding,
        aiwatcher_conversations::ReviewState,
        aiwatcher_conversations::TurnReview,
        aiwatcher_conversations::HumanFinding,
        aiwatcher_conversations::ReviewRequest,
        aiwatcher_conversations::PreferenceLabel,
        aiwatcher_conversations::RecordTurnRequest,
        aiwatcher_conversations::RecordedTurn,
        aiwatcher_conversations::ArchivedTurn,
        aiwatcher_conversations::Erasure,
        aiwatcher_conversations::ErasureReason,
        aiwatcher_conversations::ErasureReport,
        aiwatcher_conversations::ConversationHead,
        aiwatcher_conversations::ConversationPage,
        aiwatcher_conversations::TurnPage,
        aiwatcher_conversations::ExportFormat,
        aiwatcher_conversations::ExportSelection,
        aiwatcher_conversations::ExportRequest,
        aiwatcher_conversations::ExclusionReason,
        aiwatcher_conversations::ExportExclusion,
        aiwatcher_conversations::ExportCounts,
        aiwatcher_conversations::ShardRef,
        aiwatcher_conversations::JobState,
        aiwatcher_conversations::ExportJob,
        aiwatcher_conversations::ExportJobSummary,
        aiwatcher_conversations::ExportJobPage,
        aiwatcher_conversations::ExportManifest,
        aiwatcher_conversations::Withdrawal,
        aiwatcher_conversations::ExportRowsPage,
        aiwatcher_conversations::ExportIndex,
        aiwatcher_conversations::ExportVersionSummary,
        aiwatcher_conversations::ExportPage,
        crate::conversations::ArchiveConfig,
        crate::conversations::RecordTurnsBody,
        crate::conversations::RecordedTurns,
        crate::conversations::ReviewTurnBody,
        crate::conversations::ErasureBody,
        ...
        aiwatcher_training::Runtime,
        aiwatcher_training::TensorSpec,
        aiwatcher_training::ArtifactRef,
        aiwatcher_training::ResourceRequest,
        aiwatcher_training::ModelPackage,
    ...
    tags(
        ...
        (name = "labs", description = "A workshop's labs: the authored brief, and the scorecard and cohort it pins"),
        ...
        (name = "conversations", description = "The governed conversation archive: encrypted content, consent and retention, review, erasure, and the corpora exported from it"),
        ...
        (name = "execution", description = "Managed execution: compiling a definition, running it here, and reading one run"),
...
impl ApiDoc {
    ...
    pub fn document() -> utoipa::openapi::OpenApi {
        ...
        for module in [
            ...
            crate::scorecards::openapi(),
            crate::experiments::openapi(),
            crate::reviews::openapi(),
            crate::scoring::openapi(),
            crate::live::openapi(),
            ...
            crate::imports::openapi(),
            crate::conversations::openapi(),
            crate::training::openapi(),
            crate::workflows::openapi(),
            crate::executions::openapi(),
            crate::definitions::openapi(),
            crate::context::openapi(),
            crate::artifacts::openapi(),
            crate::schedules::openapi(),
...
mod tests {
    ...
    fn every_module_facade_reaches_the_document() {
        ...
        let modules = [
            ...
            ("scorecards", crate::scorecards::openapi()),
            ("experiments", crate::experiments::openapi()),
            ("reviews", crate::reviews::openapi()),
            ("scoring", crate::scoring::openapi()),
            ...
            ("imports", crate::imports::openapi()),
            ("conversations", crate::conversations::openapi()),
            ("training", crate::training::openapi()),
            ("workflows", crate::workflows::openapi()),
            ("executions", crate::executions::openapi()),
            ("definitions", crate::definitions::openapi()),
            ("context", crate::context::openapi()),
            ("artifacts", crate::artifacts::openapi()),
            ("schedules", crate::schedules::openapi()),
