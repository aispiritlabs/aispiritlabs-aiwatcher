...
Cztery strumienie pracowały równolegle z jednego snapshotu i zdały raporty, które integrator scalił: [A](iam-parallel-A-report.md), [B](iam-parallel-B-report.md), [C](iam-parallel-C-report.md), [D](iam-parallel-D-report.md) plus [runbook migracji](iam-migration-runbook.md). Decyzja, którą trzy z nich wspólnie realizują, jest zapisana jako [ADR_0033](ADR/ADR_0033_PROJECT_SCOPED_STORAGE.md); szczegóły kontraktów są w raportach i w [README IAM](../crates/aiwatcher-iam/README.md).
