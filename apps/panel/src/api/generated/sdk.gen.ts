 ...
 */
export const listHubImages = <ThrowOnError extends boolean = false>(options: Options<ListHubImagesData, ThrowOnError>): RequestResult<ListHubImagesResponses, ListHubImagesErrors, ThrowOnError> => (options.client ?? client).get<ListHubImagesResponses, ListHubImagesErrors, ThrowOnError>({ url: '/api/v1/dataset-hubs/images', ...options });
