...
import { EventFeed } from '@/features/observability/components/event-feed';
import {
  ATTRIBUTES,
  attribute,
  type AttributeId,
...
import { Badge, Button, Card, EmptyState, Stat } from '@/shared/components/ui/primitives';
import {
  openSelectionStream,
  selectionQuery,
  type LiveEventFrame,
  type StreamPhase,
} from '@/shared/lib/live';
import { cn, formatCount, formatTime } from '@/shared/lib/utils';

const routeApi = getRouteApi('/observability/live');
